      ...
      try {
        ...
        const unlistenGeneral = await listen('store-update', (event) => {
          ...
          if (updates && typeof updates === 'object') {
            console.log('🔄 Received store update in secondary window:', Object.keys(updates), {
              isActive: updates.isActive,
              robotStatus: updates.robotStatus,
              hasRobotStateFull: !!updates.robotStateFull,
              hasActiveMoves: !!updates.activeMoves,
            });
